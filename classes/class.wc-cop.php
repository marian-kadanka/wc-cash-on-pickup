	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'title' => array(
				...
				'type'        => 'text',
				'description' => __( 'Payment method description that the customer will see on your checkout.', 'wc_cop' ),
				'default'     => __( 'Cash on pickup', 'wc_cop' ),
				'desc_tip'    => true,
			),
			'description' => array(
				'title'       => __( 'Description', 'wc_cop' ),
				'type'        => 'textarea',
				'description' => __( 'Payment method description that the customer will see on your website.', 'wc_cop' ),
			...
			'instructions' => array(
				...
				'default'     => __( 'Pay with cash on pickup.', 'woocommerce' ),
				'desc_tip'    => true,
			),
