...
= 1.6 =
* Add: Updated shipping method selection to support WooCommerce 3.4+
* Add: Slovak translation
* Remove: Italian (non-complete) translation3
* Fix: Language .pot template file and standardize language path
